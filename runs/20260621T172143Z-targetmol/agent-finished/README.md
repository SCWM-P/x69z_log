...
- `03_agent/llm/codex.stderr.partial.log`
- `03_agent/llm/codex.stdout.partial.log`
...
- `90_file_diff/agent/logs/codex.stderr.partial.log`
- `90_file_diff/agent/logs/codex.stdout.partial.log`

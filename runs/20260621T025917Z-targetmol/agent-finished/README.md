...
- `90_file_diff/agent/project/analysis/baseline_audit.json`
- `90_file_diff/agent/project/analysis/baseline_tier0/failures.jsonl`
- `90_file_diff/agent/project/analysis/baseline_tier0/metrics.jsonl`
- `90_file_diff/agent/project/analysis/baseline_tier0/per_molecule.csv`
- `90_file_diff/agent/project/analysis/baseline_tier0/summary.json`
- `90_file_diff/agent/project/analysis/baseline_tier0/summary.md`
- `90_file_diff/agent/project/analysis/baseline_tier1/failures.jsonl`
- `90_file_diff/agent/project/analysis/baseline_tier1/metrics.jsonl`
- `90_file_diff/agent/project/analysis/baseline_tier1/per_molecule.csv`
- `90_file_diff/agent/project/analysis/baseline_tier1/stdout.json`
- `90_file_diff/agent/project/analysis/baseline_tier1/summary.json`
- `90_file_diff/agent/project/analysis/baseline_tier1/summary.md`
- `90_file_diff/agent/project/analysis/target_summary.json`
- `90_file_diff/agent/project/analysis/work/project_main_audit_stdout.json`
- `90_file_diff/agent/project/analysis/work/project_main_candidate.audit.json`
- `90_file_diff/agent/project/analysis/work/project_main_tier0/failures.jsonl`
- `90_file_diff/agent/project/analysis/work/project_main_tier0/metrics.jsonl`
- `90_file_diff/agent/project/analysis/work/project_main_tier0/per_molecule.csv`
- `90_file_diff/agent/project/analysis/work/project_main_tier0/summary.json`
- `90_file_diff/agent/project/analysis/work/project_main_tier0/summary.md`
- `90_file_diff/agent/project/analysis/work/project_main_tier0_stdout.json`
- `90_file_diff/agent/project/analysis/work/project_main_tier1/failures.jsonl`
- `90_file_diff/agent/project/analysis/work/project_main_tier1/metrics.jsonl`
- `90_file_diff/agent/project/analysis/work/project_main_tier1/per_molecule.csv`
- `90_file_diff/agent/project/analysis/work/project_main_tier1/summary.json`
- `90_file_diff/agent/project/analysis/work/project_main_tier1/summary.md`
- `90_file_diff/agent/project/analysis/work/project_main_tier1_stdout.json`

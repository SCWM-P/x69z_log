...
- {'target': 'result1.csv', 'row': 1, 'prep_ms': 322, 'vina_ms': None, 'smiles': 'O=C(O)c1c(-c2ccc(Cl)cc2)[nH]c2ccc(Oc3ccccc3)cc12'}
- {'target': 'result3.csv', 'row': 1, 'prep_ms': 99, 'vina_ms': None, 'smiles': 'CS(=O)(=O)c1ccc(OC2CCN(c3ncccn3)CC2)cc1'}
- {'target': 'result2.csv', 'row': 1, 'prep_ms': 94, 'vina_ms': None, 'smiles': 'CC(C)(C)NC(=O)c1ccc(Nc2ncc(C#N)cc2F)cn1'}
